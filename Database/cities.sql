...
CREATE TABLE `cities` (
    ...
    CONSTRAINT `city_province` FOREIGN KEY (`province_ID`) REFERENCES `provinces` (`ID`)
...
(7109, 71, 'Kab. Kepulauan Siau Tagulandang Biaro'),
...
(7308, 73, 'Kab. Bone'),
(7309, 73, 'Kab. Maros'),
(7310, 73, 'Kab. Pangkajene Dan Kepulauan'),
(7311, 73, 'Kab. Barru'),
(7312, 73, 'Kab. Soppeng'),
(7313, 73, 'Kab. Wajo'),
